...
{
    //qDebug() << "Draw Solid Polygon" << endl;
	...
	polygon.setOutlineThickness(-1.f);
    b2Color test;
    test.Set(105, 105, 105);
    polygon.setFillColor(SFMLDebugDraw::GLColorToSFML(color, 120));
    polygon.setOutlineColor(SFMLDebugDraw::GLColorToSFML(test));
